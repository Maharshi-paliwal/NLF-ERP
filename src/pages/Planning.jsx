                  ...
                  {filteredWorkOrders.map((workOrder, index) => (
                    <tr key={workOrder.workOrderId}>
                      ...
                      <td>
                        ...
                        <Button
                          as={Link}
                          to={`/planningsubpage/${workOrder.workOrderId}`}
                        ...
                        <Button
                          ...
                          to={
                            viewContext === "design"
                              ? `/design/${planworkOrder.workOrderId}` // Destination if viewContext is "design"
                              : `/planworkorderform/${workOrder.workOrderId}` // Destination otherwise
                          }
                          state={{ viewContext: viewContext || "operations" }}
                          className="buttonEye"
                          title="View Work Order Details"
